...
namespace libember { namespace glow
{
    ...
    class LIBEMBER_API GlowContentElement : public GlowElement
    {
        protected:
            /**
             * Initializes a new Content element with the specified glow type.
             ...
             */
            explicit GlowContentElement(GlowType const& type, ber::Tag const& contentTag);
             ...
             */
            GlowContentElement(GlowType const& type, ber::Tag const& contentTag, ber::Tag const& tag);
