...
namespace libember { namespace glow {
    ...
    namespace detail {
         ...
         */
        template<>
        struct VariantTemplate<std::string> : Variant
        {
        ...
        private:
             ...
             */
            VariantTemplate(value_type const& value)
                : Variant(ber::Type::UTF8String)
                , m_value(value)
            {}

        private:
            VariantTemplate& operator=(VariantTemplate const&);
         ...
         */
        template<>
        struct VariantTemplate<int> : Variant
        {
            friend struct libember::glow::Variant;
         ...
         */
        template<>
        struct VariantTemplate<double> : Variant
        {
            friend struct libember::glow::Variant;
    ...
    {
        return new detail::VariantTemplate<ValueType>(value);
    }
}
}
